    ...
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
        <div style={{position:"fixed",top:8,right:8,zIndex:9999,display:"flex",gap:6,padding:4,borderRadius:10,background:"rgba(255,255,255,.92)",boxShadow:"0 2px 12px rgba(0,0,0,.12)"}}>
          <a href="/" style={{padding:"6px 9px",color:"#1e2820",textDecoration:"none",fontSize:12,fontWeight:700}}>Recipes</a>
          <a href="/household" style={{padding:"6px 9px",color:"#1e2820",textDecoration:"none",fontSize:12,fontWeight:700}}>Household</a>
        </div>
        {children}
