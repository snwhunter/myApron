...
export default function Household(){
  ...
  useEffect(()=>{refresh().catch(()=>setBusy("Couldn’t load household data"))},[week]);
  ...
  return <main style={{maxWidth:1000,margin:"0 auto",padding:20,fontFamily:"Arial,sans-serif"}}>
    <header style={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:16,flexWrap:"wrap"}}><div><a href="/" style={{textDecoration:"none"}}>← Recipes & shopping</a><h1 style={{margin:"8px 0"}}>myApron household</h1><p style={{margin:0}}>Pantry, fridge, freezer, weekly plan, leftovers and purchases.</p></div><div>{busy}</div></header>
