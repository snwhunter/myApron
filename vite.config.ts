...
const productionDatabaseId = process.env.MYAPRON_D1_DATABASE_ID;

if (isCloudflareDeploy && !productionDatabaseId) {
  throw new Error(
...
const localBindingConfig = {
  ...
  d1_databases: d1
    ? [
        {
          binding: d1,
          database_name: isCloudflareDeploy ? "myapron-db" : "site-creator-d1",
